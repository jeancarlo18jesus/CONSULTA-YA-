...
import { CitasRegistro } from "@/app/actions/citasRegistro";
import { parseCookies } from "nookies";
import axios from "axios";
import estudiantes from "../../schema/estudiante.json";


export function PageCita() {
  ...
  useEffect(() => {
    ...
    const getValueCitasEstudiante = async () => {
  ...
  // @ts-expect-error
  const [state, action] = useFormState(CitasRegistro, undefined);
    ...
    <div className="bg-gray-100 min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-5xl p-8 flex flex-col md:flex-row items-center bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              >
                ...
                <option value="Sede Villa El Salvador">Sede Villa El Salvador</option>
        ...
        <div className="w-full md:w-1/2 md:pl-8 flex justify-center items-center">
          <Image
            src="/imgs/citas_home.svg"
            alt="Ilustración de cita"
            width={300}
            height={300}
      ...
      <dialog ref={modalRef} className="p-4 rounded-lg shadow-lg">
        <h3 className="text-lg font-semibold mb-2">Cita Registrada</h3>
        <p className="mb-4">Tu cita ha sido enviada exitosamente.</p>
        <button
