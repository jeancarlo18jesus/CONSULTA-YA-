...
export const AboutMovilTrabajador = ({
  usuario,
  menus_items,
        ...
        <div className="md:hidden">
              ...
              <div className="pt-4 pb-3 border-t border-gray-700">
                ...
                <div className="mt-3 px-2 space-y-1">
                 ...
                 <button onClick={getLogout} className="w-full justify-start flex items-center px-3 py-2 rounded-md text-base font-medium text-gray-400  hover:text-[#f31260]  hover:bg-gray-700 ">{menus_items.menu_5}</button>
                </div>
              </div>
            </div>
    )
